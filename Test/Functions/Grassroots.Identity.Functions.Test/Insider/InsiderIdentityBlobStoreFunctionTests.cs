...
{
    public class InsiderIdentityBlobStoreFunctionTests
    {
        ...
        public InsiderIdentityBlobStoreFunctionTests()
        {
            ...
            _configurationMock.Setup(x => x.GetValue(External.AppSettingsKey.IdentityInsiderFeedsContainer))
        ...
        public async Task BlobStorageFunctionLogsProperExceptionsIfThereIsAnErrorSavingTheFeed()
        {
            ...
            // Act
            var blobStore = new InsiderIdentityBlobStoreFunction(_storeFeedMock.Object,
        ...
        [Fact]
        public async Task InsiderIdentityBlobStoreFunction_WithInvalidIdentityFeedContainer_ThrowsError()
        {
            //Arrange
            _configurationMock.Setup(x => x.GetValue(External.AppSettingsKey.IdentityRawFeedStorageConnection))
                .Returns(() => null);
        ...
        [Fact]
        public async Task InsiderIdentityBlobStoreFunction_WithInvalidIdentityRawFeedStorageConnection_ThrowsError()
        {
            //Arrange
            _configurationMock.Setup(x => x.GetValue(External.AppSettingsKey.IdentityInsiderFeedsContainer))
                .Returns(() => null);
            ...
            _storeFeedMock.Verify(
                x => x.SaveFeed(
                    _configurationMock.Object.GetValue(External.AppSettingsKey.IdentityInsiderFeedsContainer),
                    It.IsAny<string>(), _eventGridEvent.Data.ToString(), _eventGridEvent.Id), Times.Never);
            _telemetryHandlerMock.Verify(x => x.TrackException(It.IsAny<Exception>(), null, null), Times.Once);
        }

        [Fact]
        public async Task InsiderIdentityBlobStoreFunction_WithInvalidGridEventData_ThrowsError()
        {
            //Arrange
