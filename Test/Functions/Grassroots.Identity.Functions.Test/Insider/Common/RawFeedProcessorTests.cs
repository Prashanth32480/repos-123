...
namespace Grassroots.Identity.Functions.Insider.Test.Common
{
    public class RawFeedProcessorTests
    {
        ...
        public async Task InsertRawFeed_WithValidInput_ReturnsId()
        {
            ...
            _mockFeedOperations.Setup(x => x.SaveExternalRawFeed(It.IsAny<RawFeedSaveRequestModel>()))
        ...
        public async Task SetRawFeedStatusToSuccess_WithValidInput_ReturnsId()
        {
            ...
            const int expectedResult = 123;
            _mockFeedOperations.Setup(x => x.SetExternalFeedProcessStatusToSuccess(It.IsAny<long>()))
                .ReturnsAsync(expectedResult);
        ...
        public async Task CheckRawFeedExists_WithValidInput_ReturnsTrue()
        {
            ...
            _mockFeedOperations.Setup(x => x.GetExternalRawFeedByMessageId(It.IsAny<string>()))
