...
{
    public class PlayHQIdentityBlobStoreFunctionTests
    {
        ...
        public PlayHQIdentityBlobStoreFunctionTests()
        {
            _configurationMock.Setup(x => x.GetValue(AppSettingsKey.IdentityRawFeedStorageConnection))
                .Returns(() => "Sample Connection String");

            _configurationMock.Setup(x => x.GetValue(AppSettingsKey.IdentityFeedsContainer))
            ...
            _eventGridEvent = new EventGridEvent
            {
                ...
                Data =
                    "{\"messageId\":\"Test Message ID\",\"entityId\":\"Test Entity ID\",\"eventRaisedDateTime\":\"Test Date Time\",\"eventType\":\"SHARED_PROGRAM_REGISTRATION.CREATED\",\"data\":{\"id\":\"Test Function\",\"cricketId\":\"310bee0c2b1041e981738066fc3eeea9\"}}"
            };
        }
        ...
        public async Task BlobStorageFunctionLogsProperExceptionsIfThereIsAnErrorSavingTheFeed()
        {
            ...
            // Act
            var blobStore = new PlayHQIdentityBlobStoreFunction(_storeFeedMock.Object,
        ...
        [Fact]
        public async Task PlayHQIdentityBlobStoreFunction_WithInvalidIdentityFeedContainer_ThrowsError()
        {
            //Arrange
            _configurationMock.Setup(x => x.GetValue(AppSettingsKey.IdentityRawFeedStorageConnection))
                .Returns(() => null);
        ...
        [Fact]
        public async Task PlayHQIdentityBlobStoreFunction_WithInvalidIdentityRawFeedStorageConnection_ThrowsError()
        {
            //Arrange
            _configurationMock.Setup(x => x.GetValue(AppSettingsKey.IdentityFeedsContainer))
                .Returns(() => null);
            ...
            _storeFeedMock.Verify(
                x => x.SaveFeed(
                    _configurationMock.Object.GetValue(AppSettingsKey.IdentityFeedsContainer),
                    It.IsAny<string>(), _eventGridEvent.Data.ToString(), _eventGridEvent.Id), Times.Never);
            _telemetryHandlerMock.Verify(x => x.TrackException(It.IsAny<Exception>(), null, null), Times.Once);
        }

        [Fact]
        public async Task PlayHQIdentityBlobStoreFunction_WithInvalidGridEventData_ThrowsError()
        {
            //Arrange
