...
{
    public class CdcIdentityBlobStoreFunction
    {
        ...
        public CdcIdentityBlobStoreFunction(IStoreFeed storeFeed,
        ...
        [FunctionName("CdcIdentityBlobStoreFunction")]
        public async Task Run([EventGridTrigger] EventGridEvent eventGridEvent)
        {
            _telemetryHandler.TrackTraceInfo("Received Cdc Feed Message");

            await SaveFeed(eventGridEvent);

            _telemetryHandler.TrackTraceInfo("Finished Processing Cdc Feed Message");
        }
        ...
        private async Task SaveFeed(EventGridEvent eventGridEvent)
        {
            try
            {
                _telemetryHandler.TrackTraceInfo("Saving Cdc Feed Message");
                ...
                var containerName = _configuration.GetValue(AppSettingsKey.IdentityCdcFeedsContainer);
