...
using Grassroots.Identity.Functions.Cdc;
...
namespace Grassroots.Identity.Functions.Cdc
{
    public class Startup : FunctionsStartup
    {
        ...
        {
            serviceCollection.AddTransient<IEventGridPublish, EventGridPublish>();
        ...
        {
            serviceCollection.AddTransient<ICdcAccountFeedHandler, CdcAccountFeedHandler>();
            serviceCollection.AddTransient<ICdcAccountFeedProcessor, CdcAccountFeedProcessor>();
        }
        ...
        private static void AddSharedConnections(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<IInteractServices, InteractServices>();
